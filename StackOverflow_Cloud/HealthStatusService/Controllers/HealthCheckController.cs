...
namespace HealthStatusService.Controllers
{
    public class HealthCheckController : Controller
    {
        ...
        public ActionResult HealthCheck()
        {
            ...
            var notifEntities = repo.RetrieveAllNotificationkServiceHealthCheckEntities().ToList();
            var stackEntities = repo.RetrieveAllHealthCheckEntities().ToList();

            // spajanje i filtriranje
